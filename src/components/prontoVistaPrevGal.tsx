...
// elemento demostración ///
        ...
        React.createElement('p', { className: ` mt-2 text-left text-slate-700/60 text-lg lg:ml-10 md:ml-8 ml-6 font-light text-slate-700/60 leading-normal ` }, `▪︎ Colores ejemplos: `,
            React.createElement('span', { className: `inline-block  ` }, 
                ...
                React.createElement('span', { onClick: () => setSeleccionColor("rgb(51,65,85)"), className: ` inline-block font-regular h-6 w-24 bg-slate-700 cursor-pointer rounded-md text-center align-top text-white pb-7 mr-2 mt-2 border-solid border-2 ${seleccionColor === "rgb(51,65,85)" ?      'font-medium border-black text-opacity-100' : 'font-regular border-slate-700 text-opacity-60'}  ` }, `Slate` ),
                ...
                React.createElement('span', { onClick: () => setSeleccionColor("rgba(162,28,175,1)"), className: ` inline-block h-6 w-24 bg-fuchsia-700 cursor-pointer rounded-md text-center align-top text-white pb-7       mt-2      border-solid border-2 ${seleccionColor === "rgba(162,28,175,1)" ? 'font-medium border-black text-opacity-100' : 'font-regular border-fuchsia-700 text-opacity-60'}  ` }, `Fuchsia` ) ) ),
