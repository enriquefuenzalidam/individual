...
// elemento demostración ///
        ...
        React.createElement('h5', { className: ` hyphens-none mt-8 text-left text-slate-700/80 lg:ml-4 md:ml-3 ml-2 font-regular leading-normal lg:text-xl md:text-lg sm:text-lg text-lg  `}, `Visualización de lista de navegación` ),
