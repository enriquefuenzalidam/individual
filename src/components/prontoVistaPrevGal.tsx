...
// elemento demostración ///
        ...
        React.createElement('p', { className: 'lg:text-2xl md:text-xl sm:text-xl text-lg font-light text-slate-700/70 text-justify lg:indent-6 md:indent-5 sm:indent-4 indent-4 lg:m-4 md:m-3 sm:m-2 m-2 lg:leading-relaxed md:leading-relaxed sm:leading-relaxed leading-relaxed  ' },  'En esta interfaz se pueden apreciar las opciones personalizables que dispone el componente.'),
