        ...
        return React.createElement("div", { style: imageBlockStyleD },
            imagenesLista.map((item, index) => {
                ...
                const imageBlockStyleA = {
                    ...
                    top: "1.25rem", left: isCurrent ? "50%" : isBefore1 ? "25%" : isAfter1 ? "75%" : isBefore2 ? "0%" : "100%",
                    transform: `
                        translateX(${isCurrent ? "-50%" : isBefore1 ? "-25%" : isAfter1 ? "-75%" : isBefore2 ? "0%" : "-100%"})
                        scale(${isCurrent ? 1.1 : (isBefore1 || isAfter1) ? 1.05 : (isBefore2 || isAfter2) ? 0.95 : 0.25})`,
                ...
                return React.createElement("div", { key: index, style: imageBlockStyleA },
                    React.createElement("div", { style: imageBlockStyleB },
                        ...
                        React.createElement(NextImage, { src: typeof item === "string" ? item : item.src, alt: 'Gallery Image', fill: true, style: { objectFit: 'cover', transition: 'all 700ms ease-in-out', willChange: "opacity", opacity: loadedImages[index] ? 1 : 0 } }),
