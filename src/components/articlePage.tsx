...
const ArticlePage = (props: ArticlePageProps) => {
    ...
    return React.createElement('div', { style: { position: 'relative', margin: '0', padding: '0', boxSizing: 'border-box', display: 'block', height:'auto', width: '100%', /*'linear-gradient( 54deg, white 15%, #fffaf4 38%, white)'*/ } },
        React.createElement('div', { style: { display: 'block', position: 'absolute', boxSizing: 'border-box',top: '0', left: '0', width: '100%', height: '100%', padding: '0', margin: '0', backgroundColor: 'white', backgroundImage: `url('/bb.jpg')`, backgroundPosition: '50%', backgroundAttachment: 'scroll', backgroundRepeat: 'repeat', opacity: 0.3 } }),
