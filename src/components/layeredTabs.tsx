...
*/
  ...
  const tabShoulderBlock = useCallback( (index: number, pos: number) => {
    const styleA = { display: 'inline-block', boxSizing: 'border-box', padding: '0', margin: '0', position: 'relative', height: `100%`, aspectRatio: '756 / 1486', overflow: 'hidden', transform: tabBarPosition === 0 || tabBarPosition === 2 ? pos === 0 ? "scale(1,-1)" : "translateX(-0.1rem) scale(-1,-1)" : pos === 0 ? "none" : "translateX(-0.1rem) scaleX(-1)" };
