...
// elemento demostración ///
        ...
        React.createElement('h5', { className: ` hyphens-none lg:mt-8 md:mt-6 sm:mt-5 mt-5 text-left text-slate-700/80 font-regular leading-normal lg:text-xl md:text-lg sm:text-lg text-lg  `}, `Apariencia de los selectores de navegación` ),
        ...
        React.createElement('p', { className: ` lg:mt-3 mt-1 text-left text-lg leading-normal ` },
            ...
            React.createElement('span', { onClick: () => setCajaAltura(18), className: ` inline-block h-6 w-24 rounded-md text-center align-top pb-7 mr-2 mt-2 border-solid border-2 border-slate-700 ${ cajaAltura === 18 ? 'font-semibold text-slate-700/80 border-opacity-90 cursor-default ' : 'font-regular text-slate-700/60 border-opacity-50 cursor-pointer ' } `},
                `Altura D`) ),
            React.createElement('p', { className: ` mt-2 text-left text-slate-700/60 text-lg lg:ml-6 md:ml-5 ml-4 leading-normal font-light `},
                `Altura resultante: `,
                React.createElement('span', { className: `font-semibold text-slate-700/80` },
                    `${isXlParent ? `${galAlturaXl} rem` : isLgParent ? `${galAlturaLg} rem` : isMdParent ? `${galAlturaMd} rem` : `${galAlturaSm} rem`}`)),
        React.createElement('h4', { className: ` hyphens-none lg:mt-14 md:mt-10 sm:mt-6 mt-6 text-left text-slate-700/80 font-semibold leading-normal lg:text-2xl md:text-xl sm:text-xl text-xl ` },
