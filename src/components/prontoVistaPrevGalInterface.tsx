...
const ProntoVistaPrevGalInterface: React.FC<ProntoVistaPrevGalProps> = ({ imagenesLista, discosColor = "#000", maxAltura = 32, iteracionTiempo = 3400 }) => {
...
////////////////////////////
// elemento demostración ///
        React.createElement('h4', { className: ` hyphens-none mt-10 text-left text-slate-700/80 lg:ml-4 md:ml-3 ml-2 font-semibold leading-normal lg:text-2xl md:text-xl sm:text-xl text-xl ` }, `Opciones personalizables` ),
        React.createElement('p', { className: 'lg:text-2xl md:text-xl sm:text-xl text-lg font-light text-slate-700/70 text-left lg:indent-6 md:indent-5 sm:indent-4 indent-4 lg:m-4 md:m-3 sm:m-2 m-2 lg:leading-relaxed md:leading-relaxed sm:leading-relaxed leading-relaxed  ' },  'En esta interfaz se pueden apreciar las opciones personalizables que dispone el componente.'),
        React.createElement('h5', { className: ` hyphens-none mt-8 text-left text-slate-700/80 lg:ml-4 md:ml-3 ml-2 font-regular leading-normal lg:text-xl md:text-lg sm:text-lg text-lg  `}, `Apariencia de los selectores de navegación` ),
        ...
        React.createElement('h5', { className: ` hyphens-none mt-8 text-left text-slate-700/80 lg:ml-4 md:ml-3 ml-2 font-regular leading-normal lg:text-xl md:text-lg sm:text-lg text-lg  `}, `Visualización de los selectores de navegación` ),
        React.createElement('p', { className: ` mt-2 text-left text-lg lg:ml-4 md:ml-3 ml-2 leading-normal ` },
        ...
        React.createElement('h5', { className: ` hyphens-none mt-8 text-left text-slate-700/80 lg:ml-4 md:ml-3 ml-2 font-regular leading-normal lg:text-xl md:text-lg sm:text-lg text-lg  `}, `Altura máxima de la galería de previsualización ` ),
        React.createElement('p', { className: ` mt-2 text-left text-lg lg:ml-4 md:ml-3 ml-2 leading-normal ` },
        ...
        React.createElement('h5', { className: ` hyphens-none mt-8 text-left text-slate-700/80 lg:ml-4 md:ml-3 ml-2 font-semibold leading-normal lg:text-2xl md:text-xl sm:text-xl text-xl ` }, `Acerca de la altura de la galería de previsualización` ),
        React.createElement('div', { style: { }},
        React.createElement('p', { className: `   lg:text-2xl md:text-xl sm:text-xl text-lg font-light text-slate-700/70 text-left lg:indent-6 md:indent-5 sm:indent-4 indent-4 lg:m-4 md:m-3 sm:m-2 m-2 lg:leading-relaxed md:leading-relaxed sm:leading-relaxed leading-relaxed `}, 'El alto de la galería de previsualización se ajusta en relación su ancho, que es el ancho del bloque dentro del cual se encuentra inscrita. Su altura tiene tres medidas fijas: A, B, C y D, de modo que, por ejemplo, si se elige la menor, la D, esa será la altura para todos lo anchos que alcance la galería de previsualización. Pero si se eligiera la más alta, la A, esa altura solo se alcanzará si el ancho del elemento que contiene a la galería de previsualización, fuera igual o mayor a los 1024 pixeles; para los anchos inferiores, se auto ajustará siguiendo las cuatro alturas predeterminadas. Aquí, el dinamismo descrito puede ser apreciado seleccionando una de las alturas predeterminadas, redimesionando la ventana y viendo el alto resultante.') )
////////////////////////////
////////////////////////////
...
export default ProntoVistaPrevGalInterface;
