...
const Header: React.FC = () => {
    ...
    return React.createElement("header", { style: { position: "relative", boxSizing: 'border-box', display: "block" } },
        React.createElement("section", { style: { maxWidth: "64rem", position: "relative", boxSizing: 'border-box', zIndex: "20", paddingBottom: lgScreen ? "0.4rem" : mdScreen ? "0.3rem" : smScreen ? "0.3rem" : "0.3rem", display: "block", transition: "all 300ms ease-in-out", height: 'auto' } },
            ...
            React.createElement("h1", { title: 'individual.cl', style: { position: 'relative', boxSizing: 'border-box', background: 'black', display: 'inline-block', width: lgScreen ? '8rem' : mdScreen ? '6.5rem' : smScreen ? '5.9rem' : '5rem', aspectRatio: 173 / 239, overflow: 'hidden', borderRadius: lgScreen ? '0.3rem' : mdScreen ? '0.25rem' : smScreen ? '0.2rem' : '0.2rem', transition: 'all 300ms ease-in-out',
                boxShadow: lgScreen ? '0 0.813rem 0.813rem 0.125rem rgba(0, 0, 0, 0.2), 0 0.5rem 0.5rem -0.313rem rgba(0, 0, 0, 0.6)'
                ...
                margin: lgScreen ? '1.5rem 0 -3.8rem 4.5rem' : mdScreen ? '1.5rem 0 -3.1rem 3.7rem' : smScreen ? '1.875rem 0 -2.7rem 3.4rem' : '1.5rem 0 -2.2rem 2.1rem' }}, 
