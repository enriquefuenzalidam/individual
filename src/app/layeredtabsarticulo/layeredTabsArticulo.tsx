    ...
    articuloTexto: [
        ...
        React.createElement('p', { style: { ...pStyleC } },
          ...
          React.createElement('p', { style: { display: 'block', boxSizing: 'border-box', position: 'relative', textIndent: '-' + dynSzGttr('1.5','1.5','1.25','1','1','1') + 'rem', hyphens: 'auto', textAlign: 'left', fontSize: dynSzGttr('1.5','1.5','1.25','1.25','1.125','1.125') + 'rem', fontWeight: 400, color: 'rgba(51,65,85,0.6)', lineHeight: 1.625, padding: '0', marginTop: dynSzGttr('1','1','0.75','0.5','0.5','0.5') + 'rem', marginRight: '0', marginBottom: dynSzGttr('2.25','2.25','2','1.75','1.75','1.75') + 'rem', marginLeft: dynSzGttr('3','3','2.5','2','2','2') + 'rem' } },
            React.createElement('span', { style: { ...pBold } }, '—'), React.createElement(Link, { lang: 'en', replace: false, prefetch: true, scroll: true, onMouseEnter: () => setRepIsHovered(true), onMouseLeave: () => setRepIsHovered(false), href: 'https://github.com/enriquefuenzalidam/layeredtabs', target: '_blank', rel: 'noopener noreferrer', title: 'Ir repositorio en GitHub de LayeredTabs', style: { ...pBold, fontStyle: 'italic', textDecoration: repIsHovered ? 'underline' : 'none', } }, 'github.com/enriquefuenzalidam/layeredtabs', React.createElement('span', { style: { display: 'inline-block', boxSizing: 'border-box', position: 'relative', margin: '0 0 0 0.35rem', padding: '0', width: dynSzGttr('1.5','1.5','1.25','1.25','1.125','1.125') + 'rem', height: 'auto', verticalAlign: 'text-bottom' } }, React.createElement(ExtLink, null) ) ) )
    ],
...
export default LayeredTabsArticulo;
  ...
  /*
  return React.createElement('section', { style: { display: 'block', padding: '0', margin: '0', boxSizing: 'border-box', position: 'relative', fontFamily: '"Pangea Trial", sans-serif', transition: 'opacity 500ms ease-in-out', opacity: pageLoaded ? 1 : 0, pointerEvents: pageLoaded ? 'auto' : 'none', letterSpacing: '-0.008rem' } },
