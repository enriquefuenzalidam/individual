...
const LayeredTabsArticulo: React.FC = () => {
  ...
  const tabsContentList = [ 
      ...
      { title: 'Modernize Template', content: (<iframe src="https://modernize-nextjs-free.vercel.app/" width="100%" height="100%" className={` w-full h-full `}/>) },
